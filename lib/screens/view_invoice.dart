      ...
      floatingActionButton: Consumer<InvoiceProvider>(
        builder: (context, provider,child) {
          return FloatingActionButton(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      ...
                      content: SizedBox(
                        ...
                        child: Column(
                          children: [
                            const Text("Invoice has saved as an image into"),
                            Text(result["path"]),
                          ],
                        ),
                      ),
            ...
            child: provider.invoiceSaveStatus == Status.LOADING ? const CupertinoActivityIndicator() : const Icon(Icons.save),
          ...
          children: [
            Screenshot(
              ...
              child: InvoiceWidget(
                ...
                qrData: {
                  "COMPANY NAME": info.company!.enName,
                  "VAT NUMBER": info.company!.vatNo,
                  "DATE AND TIME": invoice.date,
                  "TOTAL AMOUNT": invoice.paidAmt,
